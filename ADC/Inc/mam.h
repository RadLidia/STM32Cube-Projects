...
typedef struct
{
	uint32_t CSR;    /*!< ADC Common status register,                  Address offset: ADC1 base address + 0x300 */
	uint32_t CCR;    /*!< ADC common control register,                 Address offset: ADC1 base address + 0x304 */
